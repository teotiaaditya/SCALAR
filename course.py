...
class CourseClass:
    def __init__(self,root):
        ...
        #===title=====
        title=Label(self.root, text="Manage Courses", font=("goudy old style", 20, "bold"), bg="#033054", fg="white") .place(x=10,y=15,relwidth=1, height=35)
...
#================================================================
    ...
    #                 messagebox.showerror("Error", "Select Course from list",parent=self.root)
    #             else:
    #                 cur.execute("update course duration=?, charges=?, description=? where set name=?",(
    #                     self.var_duration.get(),
    #                     self.var_charges.get(),
    #                     self.txt_description.get("1.0",END),
    #                     self.var_course.get()
